...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // ✅ Define available years for each class-board combo
  const yearsByClassBoard = {
    "3": { "tbse": ["2024", "2023"], "cbse": ["2024"], "icse": ["2023"], "wbbse": ["2024", "2022"] },
    "4": { "tbse": ["2024"], "cbse": ["2023"], "icse": ["2024"], "wbbse": ["2023"] },
    "5": { "tbse": ["2024", "2023"], "cbse": ["2024"], "icse": ["2023"], "wbbse": ["2022"] },
    "10": { "tbse": ["2024", "2023", "2022"], "cbse": ["2024", "2023"], "icse": ["2023"], "wbbse": ["2022"] },
    "12": { "tbse": ["2024", "2023"], "cbse": ["2024"], "icse": ["2024"], "wbbse": ["2023"] }
  ...
  classSelect?.addEventListener("change", () => {
    ...
    defaultBoard.value = "";
    defaultBoard.textContent = "Select Board";
    boardSelect.appendChild(defaultBoard);
  ...
  // When Board changes (now adds years dynamically)
  boardSelect?.addEventListener("change", () => {
    const cls = classSelect.value;
    const board = boardSelect.value;
    ...
    if (cls && board && yearsByClassBoard[cls] && yearsByClassBoard[cls][board]) {
      yearsByClassBoard[cls][board].forEach(year => {
        const option = document.createElement("option");
        option.value = year;
